...
MAP
    ...
    EXTENT -20037508.34 -20048966.10 20037508.34 20048966.10 ## should be defined for better performance
    UNITS METERS
    ...
    WEB
        METADATA
            ...
            "wms_onlineresource" "${web_protocol}://${host}${entry_point}mapserv_proxy"
            "wms_srs" "EPSG:3857"
            "wms_encoding" "UTF-8"
            "wms_enable_request" "*"
            "wfs_enable_request" "!*"
