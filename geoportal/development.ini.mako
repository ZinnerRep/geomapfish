...
mako.directories = geomapfish_geoportal:templates
...
[loggers]
keys = root, sqlalchemy, gunicorn.access, gunicorn.error, c2cgeoportal_commons, c2cgeoportal_geoportal, c2cgeoportal_admin, geomapfish_geoportal, c2cwsgiutils
...
[logger_geomapfish_geoportal]
level = %(LOG_LEVEL)s
handlers =
qualname = geomapfish_geoportal
