...
In the directive, the template url is written as follow: "templateUrl: mypackage.baseTemplateUrl + '/<component>/<partial>.html'".

In the main html file, the debug section should contain "mypackage.baseTemplateUrl = '${request.static_url("mypackage_geoportal:static-ngeo/components")}';"
