...
mako.directories = mypackage_geoportal:templates
...
[loggers]
keys = root, sqlalchemy, gunicorn.access, gunicorn.error, c2cgeoportal_commons, c2cgeoportal_geoportal, c2cgeoportal_admin, mypackage_geoportal, c2cwsgiutils
...
[logger_mypackage_geoportal]
level = %(LOG_LEVEL)s
handlers =
qualname = mypackage_geoportal
